...
.. warning:: 
    ...
    compared to the checksum of all RPCs in the script of the target peer. This may generate an
    error unrelated to the RPC function you are testing.

    If these conditions are not fulfilled, the script may print an error or cause unwanted behavior.
    When any RPC function is accessed, a checksum of all RPCs in this peer's script file will be
    compared to the checksum of all RPCs in the script of the target peer. This may generate an
    error unrelated to the RPC function you are building and testing. See further explanation and
